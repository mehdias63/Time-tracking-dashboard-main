...
export default function Card({ color, icon, title, text, time }) {
  return (
    <div className="relative mb-20 md:mb-20 lg:mb-40">
      <div
      ...
      <div className="text-[#FFF] bg-dark-blue w-[20rem] h-[8rem] md:w-[12.5rem] lg:h-[12.5rem] rounded-xl p-4 flex flex-col justify-center gap-6 absolute top-10">
